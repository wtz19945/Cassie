...
classdef Cassie_SSDS_Param < ...
    ...
    methods (Access = protected)
        ...
        function [gains,weights,stepping_command,velocity_command] = stepImpl(obj, cassieOutputs, step_time_change)
...
%                     end
                    ...
                    if obj.is_IK == 1
                        ...
                        if obj.globalTime >= 18
                            stepping_command(3) = .1;
                        end
                    end
                else
                    % tune z gain
