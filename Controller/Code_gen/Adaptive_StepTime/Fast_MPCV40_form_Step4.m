function [Aeq,beq,Aiq,biq,H,f] = Fast_MPCV40_form_Step4(states,Nodes,r,qo,states_ref,MPC_index,weights,foot_info,Obs_Info)
...
if step_index == 1
    ...
    [Aeq,beq] = EqFast_LeftStart4V40(CoM_x,CoM_y,CP_x,CP_y,ftx,fty);
    [Aiq,biq] = IqFast_LeftStart4V40(CoM_x, CoM_y, qo, r1, r2 ,CP_x,CP_y,ftx,fty,d_foot,Obs_Info);
    
    % Develop The Objective Function Matrix and Vector
    [H,f] = ObjFast_LeftStart4V40(CP_x,CP_y,x_ref, y_ref,Qx,Qy,cRx,cRy,cWx,cWy, ob_cost, ftx);
else
    % Develop the Constraints Matrix and Vector
    [Aeq,beq] = EqFast_RightStart4V40(CoM_x,CoM_y,CP_x,CP_y,ftx,fty);
    [Aiq,biq] = IqFast_RightStart4V40(CoM_x, CoM_y, qo, r1, r2, CP_x,CP_y,ftx,fty,d_foot,Obs_Info);
    
    % Develop The Objective Function Matrix and Vector
    [H,f] = ObjFast_RightStart4V40(CP_x,CP_y,x_ref, y_ref,Qx,Qy,cRx,cRy,cWx,cWy,ob_cost, ftx);
end
