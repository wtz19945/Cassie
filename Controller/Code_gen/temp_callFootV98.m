...
weights = [cost;0;2500;0;2500;10000;10000;1800;1800;500;1;10;50000;10000;10000;100000];
...
foot_future_info = [zeros(4,1);.14*ones(4,1);[fobs_ic(1:2);fobs_ic(4:5);fobs_ic(7:8);fobs_ic(10:11)];0.3*ones(4,1)];
foot_info = [ftx;fty;.8;.3];

[Aeq,beq,Aiq,biq,H,f] = temp_MPC3DFootV98_form_Step0(states,Nodes,r,qo,states_ref,MPC_index,weights,foot_info,foot_obs_info,foot_future_info);
size([Aeq;Aiq])
[Aeq,beq,Aiq,biq,H,f] = temp_MPC3DFootV98_form_Step1(states,Nodes,r,qo,states_ref,MPC_index,weights,foot_info,foot_obs_info,foot_future_info);
size([Aeq;Aiq])
[Aeq,beq,Aiq,biq,H,f] = temp_MPC3DFootV98_form_Step2(states,Nodes,r,qo,states_ref,MPC_index,weights,foot_info,foot_obs_info,foot_future_info);
size([Aeq;Aiq])
[Aeq,beq,Aiq,biq,H,f] = temp_MPC3DFootV98_form_Step3(states,Nodes,r,qo,states_ref,MPC_index,weights,foot_info,foot_obs_info,foot_future_info);
size([Aeq;Aiq])
