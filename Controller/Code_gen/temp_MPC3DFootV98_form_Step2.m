function [Aeq,beq,Aiq,biq,H,f] = temp_MPC3DFootV98_form_Step2(states,Nodes,r,qo,states_ref,MPC_index,weights,foot_info,foot_obs_info,foot_future_info)
...
if step_index == 1
    ...
    [Aeq,beq] = Eq_LeftStart23DFootV98(CoM_x,CoM_y, CoM_z,zh,ftx,fty,eq_in);
    [Aiq,biq] = Iq_LeftStart23DFootV98(CoM_x, CoM_y, CoM_z,x_traj,y_traj,z_traj, qo, r1, r2 ,CP_x,CP_y,ftx,fty,d_foot,iq_in,in1,in2,in3,in4);
    
    % Develop The Objective Function Matrix and Vector
    [H,f] = Obj_LeftStart23DFootV98(CP_x,CP_y,x_ref, y_ref,z_ref,Qx,Qy,Qz,cRx,cRy,cRz,cWx,cWy, ob_cost, ftx,obj_in);
else
    % Develop the Constraints Matrix and Vector
    [Aeq,beq] = Eq_RightStart23DFootV98(CoM_x,CoM_y, CoM_z,zh,ftx,fty,eq_in);
    [Aiq,biq] = Iq_RightStart23DFootV98(CoM_x, CoM_y, CoM_z,x_traj,y_traj,z_traj, qo, r1, r2, CP_x,CP_y,ftx,fty,d_foot,iq_in,in1,in2,in3,in4);
    
    % Develop The Objective Function Matrix and Vector
    [H,f] = Obj_RightStart23DFootV98(CP_x,CP_y,x_ref, y_ref,z_ref,Qx,Qy,Qz,cRx,cRy,cRz,cWx,cWy, ob_cost, ftx,obj_in);
end
end
