 ...
 *
 * _coder_Fast_MPCV30_form_Step1_api.cpp
 *
 * Code generation for function '_coder_Fast_MPCV30_form_Step1_api'
 *
 */
...
static const mxArray *c_emlrt_marshallOut(const real_T u[24310]);
...
static const mxArray *c_emlrt_marshallOut(const real_T u[24310])
{
  ...
  static const int32_T iv5[2] = { 143, 170 };
  ...
  const emlrtMsgIdentifier *msgId))[8]
{
  ...
  void Fast_MPCV30_form_Step1_api(Fast_MPCV30_form_Step1StackData *SD, const
  mxArray * const prhs[9], const mxArray *plhs[6])
{
  ...
  Aiq = (real_T (*)[24310])mxMalloc(sizeof(real_T [24310]));
  ...
  Fast_MPCV30_form_Step1(SD, &st, *states, Nodes, *r, *qo, *states_ref,
...
/* End of code generation (_coder_Fast_MPCV30_form_Step1_api.cpp) */
