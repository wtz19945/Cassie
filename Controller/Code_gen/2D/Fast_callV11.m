...
[Aeq,beq,Aiq,biq,H,f] = Fast_MPCV11_form_Step0(states,Nodes,r,qo,states_ref,MPC_index,weights,foot_info,Obs_Info);
size([Aeq;Aiq])
[Aeq,beq,Aiq,biq,H,f] = Fast_MPCV11_form_Step1(states,Nodes,r,qo,states_ref,MPC_index,weights,foot_info,Obs_Info);
size([Aeq;Aiq])
[Aeq,beq,Aiq,biq,H,f] = Fast_MPCV11_form_Step2(states,Nodes,r,qo,states_ref,MPC_index,weights,foot_info,Obs_Info);
size([Aeq;Aiq])
[Aeq,beq,Aiq,biq,H,f] = Fast_MPCV11_form_Step3(states,Nodes,r,qo,states_ref,MPC_index,weights,foot_info,Obs_Info);
size([Aeq;Aiq])

% [Aeq,beq,Aiq,biq,H,f] = Fast_MPCV11_form_Step0_mex(states,Nodes,r,qo,states_ref,MPC_index,weights,foot_info,Obs_Info);
% size([Aeq;Aiq])
% [Aeq,beq,Aiq,biq,H,f] = Fast_MPCV11_form_Step1_mex(states,Nodes,r,qo,states_ref,MPC_index,weights,foot_info,Obs_Info);
% size([Aeq;Aiq])
% [Aeq,beq,Aiq,biq,H,f] = Fast_MPCV11_form_Step2_mex(states,Nodes,r,qo,states_ref,MPC_index,weights,foot_info,Obs_Info);
% size([Aeq;Aiq])
% [Aeq,beq,Aiq,biq,H,f] = Fast_MPCV11_form_Step3_mex(states,Nodes,r,qo,states_ref,MPC_index,weights,foot_info,Obs_Info);
% size([Aeq;Aiq])
