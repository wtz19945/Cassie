 ...
 *
 * Code generation for function '_coder_Fast_MPCV12_form_Step0_api'
 *
 */
...
static const mxArray *c_emlrt_marshallOut(const real_T u[21920]);
...
static const mxArray *c_emlrt_marshallOut(const real_T u[21920])
{
  ...
  static const int32_T iv5[2] = { 137, 160 };
...
void Fast_MPCV12_form_Step0_api(Fast_MPCV12_form_Step0StackData *SD, const
  mxArray * const prhs[9], const mxArray *plhs[6])
{
  ...
  Aiq = (real_T (*)[21920])mxMalloc(sizeof(real_T [21920]));
  ...
  Fast_MPCV12_form_Step0(SD, &st, *states, Nodes, *r, *qo, *states_ref,
...
/* End of code generation (_coder_Fast_MPCV12_form_Step0_api.cpp) */
