 ...
 *
 * _coder_Fast_MPCV12_form_Step3_api.cpp
 *
 * Code generation for function '_coder_Fast_MPCV12_form_Step3_api'
 *
 */
...
static const mxArray *c_emlrt_marshallOut(const real_T u[20000])
{
  ...
  static const int32_T iv5[2] = { 125, 160 };
...
void Fast_MPCV12_form_Step3_api(Fast_MPCV12_form_Step3StackData *SD, const
  mxArray * const prhs[9], const mxArray *plhs[6])
{
  ...
  Aiq = (real_T (*)[20000])mxMalloc(sizeof(real_T [20000]));
  ...
  Fast_MPCV12_form_Step3(SD, &st, *states, Nodes, *r, *qo, *states_ref,
...
/* End of code generation (_coder_Fast_MPCV12_form_Step3_api.cpp) */
