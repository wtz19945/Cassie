function [Aeq,beq,Aiq,biq,H,f] = Fast_MPCV20_form_Step3(states,Nodes,r,qo,states_ref,MPC_index,weights,foot_info,Obs_Info)
...
if step_index == 1
    ...
    [Aeq,beq] = EqFast_LeftStart3V20(CoM_x,CoM_y,CP_x,CP_y,ftx,fty);
    [Aiq,biq] = IqFast_LeftStart3V20(CoM_x, CoM_y, qo, r1, r2 ,CP_x,CP_y,ftx,fty,d_foot,Obs_Info);
    
    % Develop The Objective Function Matrix and Vector
    [H,f] = ObjFast_LeftStart3V20(CP_x,CP_y,x_ref, y_ref,Qx,Qy,cRx,cRy,cWx,cWy, ob_cost, ftx);
else
    % Develop the Constraints Matrix and Vector
    [Aeq,beq] = EqFast_RightStart3V20(CoM_x,CoM_y,CP_x,CP_y,ftx,fty);
    [Aiq,biq] = IqFast_RightStart3V20(CoM_x, CoM_y, qo, r1, r2, CP_x,CP_y,ftx,fty,d_foot,Obs_Info);
    
    % Develop The Objective Function Matrix and Vector
    [H,f] = ObjFast_RightStart3V20(CP_x,CP_y,x_ref, y_ref,Qx,Qy,cRx,cRy,cWx,cWy, ob_cost, ftx);
end
end
