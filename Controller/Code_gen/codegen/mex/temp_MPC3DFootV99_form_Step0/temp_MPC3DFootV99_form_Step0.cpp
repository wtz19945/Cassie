...
static emlrtRSInfo emlrtRSI = { 54,    /* lineNo */
  "temp_MPC3DFootV99_form_Step0",      /* fcnName */
  "D:\\Cassie_Avoidance\\Obstacle_Avoidance_OpenLoopNoCassie\\Code_gen\\temp_MPC3DFootV99_form_Step0.m"/* pathName */
};
...
static emlrtRTEInfo emlrtRTEI = { 1,   /* lineNo */
  34,                                  /* colNo */
  "temp_MPC3DFootV99_form_Step0",      /* fName */
  "D:\\Cassie_Avoidance\\Obstacle_Avoidance_OpenLoopNoCassie\\Code_gen\\temp_MPC3DFootV99_form_Step0.m"/* pName */
};
...
void temp_MPC3DFootV99_form_Step0(c_temp_MPC3DFootV99_form_Step0S *SD, const
  ...
  Aiq[36058], real_T biq[149], real_T H[58564], real_T f[242])
{
  int32_T i;
  real_T x_ref[5];
  real_T y_ref[5];
  ...
  if (MPC_index[0] == 1.0) {
    ...
    /* EQ_LEFTSTART03DFOOTV99 */
    /*     [AEQ,BEQ] = EQ_LEFTSTART03DFOOTV99(IN1,IN2,IN3,ZH1,IN5,IN6,IN7) */
    /*     This function was generated by the Symbolic Math Toolbox version 8.0. */
    /*     10-Jul-2023 16:53:42 */
    t2 = 1.0 / states_ref[6];
    t3 = t2 * 0.981;
    SD->f3.dv2[0] = -1.0;
    ...
    beq[123] = eq_in[1];
    st.site = &c_emlrtRSI;
    Iq_LeftStart03DFootV99(SD, &st, *(real_T (*)[17])&states_ref[7], *(real_T (*)
    ...
    /*  Develop The Objective Function Matrix and Vector */
    Obj_LeftStart03DFootV99(SD, states[4], states[5], x_ref, y_ref, *(real_T (*)
    ...
    /*  Develop the Constraints Matrix and Vector */
    /* EQ_RIGHTSTART03DFOOTV99 */
    /*     [AEQ,BEQ] = EQ_RIGHTSTART03DFOOTV99(IN1,IN2,IN3,ZH1,IN5,IN6,IN7) */
    /*     This function was generated by the Symbolic Math Toolbox version 8.0. */
    /*     10-Jul-2023 17:00:42 */
    t2 = 1.0 / states_ref[6];
    t3 = t2 * 0.981;
    SD->f3.dv2[0] = -1.0;
    SD->f3.dv2[1] = t2 * -0.981;
    ...
    beq[123] = eq_in[1];
    st.site = &d_emlrtRSI;
    Iq_RightStart03DFootV99(SD, &st, *(real_T (*)[17])&states_ref[7], *(real_T (*)
      [17])&states_ref[24], *(real_T (*)[17])&states_ref[41], qo, r1, r2,
      states[4], states[5], *(real_T (*)[3])&foot_info[0], *(real_T (*)[3])&
      foot_info[3], *(real_T (*)[2])&foot_info[6], iq_in, *(real_T (*)[4])&
      foot_future_info[0], *(real_T (*)[4])&foot_future_info[4], *(real_T (*)[8])
    ...
    /*  Develop The Objective Function Matrix and Vector */
    /* OBJ_RIGHTSTART03DFOOTV99 */
    /*     [H,F] = OBJ_RIGHTSTART03DFOOTV99(CPX1,CPY1,IN3,IN4,IN5,IN6,IN7,IN8,CRX1,CRY1,CRZ1,CWX1,CWY1,M1,IN15,IN16) */
    /*     This function was generated by the Symbolic Math Toolbox version 8.0. */
    /*     10-Jul-2023 17:06:36 */
    t2 = weights[1] * 2.0;
    t3 = weights[2] * 2.0;
    t4 = weights[3] * 2.0;
    t5 = weights[4] * 2.0;
    ...
    SD->f3.t2[1944] = t2;
    memset(&SD->f3.t2[1945], 0, 242U * sizeof(real_T));
    SD->f3.t2[2187] = t3;
    memset(&SD->f3.t2[2188], 0, 242U * sizeof(real_T));
    SD->f3.t2[2430] = t2;
    ...
    SD->f3.t2[3888] = t2;
    memset(&SD->f3.t2[3889], 0, 242U * sizeof(real_T));
    SD->f3.t2[4131] = t3;
    memset(&SD->f3.t2[4132], 0, 242U * sizeof(real_T));
    SD->f3.t2[4374] = t2;
    ...
    SD->f3.t2[5832] = t2;
    memset(&SD->f3.t2[5833], 0, 242U * sizeof(real_T));
    SD->f3.t2[6075] = t3;
    memset(&SD->f3.t2[6076], 0, 242U * sizeof(real_T));
    SD->f3.t2[6318] = t2;
    ...
    SD->f3.t2[7776] = t2;
    memset(&SD->f3.t2[7777], 0, 242U * sizeof(real_T));
    SD->f3.t2[8019] = t3;
    memset(&SD->f3.t2[8020], 0, 242U * sizeof(real_T));
    SD->f3.t2[8262] = t4;
    ...
    SD->f3.t2[10206] = t4;
    memset(&SD->f3.t2[10207], 0, 242U * sizeof(real_T));
    SD->f3.t2[10449] = t5;
    memset(&SD->f3.t2[10450], 0, 242U * sizeof(real_T));
    SD->f3.t2[10692] = t4;
    ...
    SD->f3.t2[12150] = t4;
    memset(&SD->f3.t2[12151], 0, 242U * sizeof(real_T));
    SD->f3.t2[12393] = t5;
    memset(&SD->f3.t2[12394], 0, 242U * sizeof(real_T));
    SD->f3.t2[12636] = t4;
    ...
    SD->f3.t2[14094] = t4;
    memset(&SD->f3.t2[14095], 0, 242U * sizeof(real_T));
    SD->f3.t2[14337] = t5;
    memset(&SD->f3.t2[14338], 0, 242U * sizeof(real_T));
    SD->f3.t2[14580] = t4;
    ...
    SD->f3.t2[16038] = t4;
    memset(&SD->f3.t2[16039], 0, 242U * sizeof(real_T));
    SD->f3.t2[16281] = t5;
    memset(&SD->f3.t2[16282], 0, 242U * sizeof(real_T));
    SD->f3.t2[16524] = t6;
    ...
    SD->f3.t2[24543] = t7;
    memset(&SD->f3.t2[24544], 0, 1214U * sizeof(real_T));
    SD->f3.t2[25758] = t8;
    ...
    SD->f3.t2[26531] = -t8;
    memset(&SD->f3.t2[26532], 0, 198U * sizeof(real_T));
    SD->f3.t2[26730] = t8;
    ...
    SD->f3.t2[27499] = -t8;
    SD->f3.t2[27500] = -t8;
    memset(&SD->f3.t2[27501], 0, 201U * sizeof(real_T));
    SD->f3.t2[27702] = t8;
    ...
    SD->f3.t2[28468] = -t8;
    SD->f3.t2[28469] = -t8;
    memset(&SD->f3.t2[28470], 0, 204U * sizeof(real_T));
    SD->f3.t2[28674] = t8;
    ...
    SD->f3.t2[28711] = -t8;
    SD->f3.t2[28712] = -t8;
    memset(&SD->f3.t2[28713], 0, 1176U * sizeof(real_T));
    SD->f3.t2[29889] = t9;
    ...
    SD->f3.t2[30649] = -t9;
    memset(&SD->f3.t2[30650], 0, 211U * sizeof(real_T));
    SD->f3.t2[30861] = t9;
    ...
    SD->f3.t2[31617] = -t9;
    SD->f3.t2[31618] = -t9;
    memset(&SD->f3.t2[31619], 0, 214U * sizeof(real_T));
    SD->f3.t2[31833] = t9;
    ...
    SD->f3.t2[32586] = -t9;
    SD->f3.t2[32587] = -t9;
    memset(&SD->f3.t2[32588], 0, 217U * sizeof(real_T));
    SD->f3.t2[32805] = t9;
    ...
    SD->f3.t2[36936] = t10;
    memset(&SD->f3.t2[36937], 0, 195U * sizeof(real_T));
    SD->f3.t2[37132] = -t8;
    SD->f3.t2[37133] = -t8;
    SD->f3.t2[37134] = -t8;
    SD->f3.t2[37135] = -t8;
    ...
    SD->f3.t2[37179] = weights[5] * 26.0;
    SD->f3.t2[37180] = t11;
    SD->f3.t2[37181] = t12;
    SD->f3.t2[37182] = t8;
    memset(&SD->f3.t2[37183], 0, 195U * sizeof(real_T));
    SD->f3.t2[37378] = -t8;
    SD->f3.t2[37379] = -t8;
    SD->f3.t2[37380] = -t8;
    SD->f3.t2[37381] = -t8;
    ...
    SD->f3.t2[37423] = t12;
    SD->f3.t2[37424] = t8;
    memset(&SD->f3.t2[37425], 0, 199U * sizeof(real_T));
    SD->f3.t2[37624] = -t8;
    SD->f3.t2[37625] = -t8;
    SD->f3.t2[37626] = -t8;
    SD->f3.t2[37627] = -t8;
    ...
    SD->f3.t2[37665] = t12;
    SD->f3.t2[37666] = t8;
    memset(&SD->f3.t2[37667], 0, 203U * sizeof(real_T));
    SD->f3.t2[37870] = -t8;
    ...
    SD->f3.t2[37907] = t8;
    SD->f3.t2[37908] = t8;
    memset(&SD->f3.t2[37909], 0, 208U * sizeof(real_T));
    SD->f3.t2[38117] = -t9;
    SD->f3.t2[38118] = -t9;
    SD->f3.t2[38119] = -t9;
    SD->f3.t2[38120] = -t9;
    ...
    SD->f3.t2[38151] = weights[6] * 26.0;
    SD->f3.t2[38152] = t13;
    SD->f3.t2[38153] = t14;
    SD->f3.t2[38154] = t9;
    memset(&SD->f3.t2[38155], 0, 208U * sizeof(real_T));
    SD->f3.t2[38363] = -t9;
    SD->f3.t2[38364] = -t9;
    SD->f3.t2[38365] = -t9;
    SD->f3.t2[38366] = -t9;
    ...
    SD->f3.t2[38395] = t14;
    SD->f3.t2[38396] = t9;
    memset(&SD->f3.t2[38397], 0, 212U * sizeof(real_T));
    SD->f3.t2[38609] = -t9;
    SD->f3.t2[38610] = -t9;
    SD->f3.t2[38611] = -t9;
    SD->f3.t2[38612] = -t9;
    ...
    SD->f3.t2[38637] = t14;
    SD->f3.t2[38638] = t9;
    memset(&SD->f3.t2[38639], 0, 216U * sizeof(real_T));
    SD->f3.t2[38855] = -t9;
    ...
    SD->f3.t2[49086] = t9;
    memset(&SD->f3.t2[49087], 0, 485U * sizeof(real_T));
    SD->f3.t2[49572] = t16;
    memset(&SD->f3.t2[49573], 0, 242U * sizeof(real_T));
    SD->f3.t2[49815] = t16;
    memset(&SD->f3.t2[49816], 0, 242U * sizeof(real_T));
    SD->f3.t2[50058] = t16;
    memset(&SD->f3.t2[50059], 0, 242U * sizeof(real_T));
    SD->f3.t2[50301] = t16;
    memset(&SD->f3.t2[50302], 0, 485U * sizeof(real_T));
    SD->f3.t2[50787] = t17;
    memset(&SD->f3.t2[50788], 0, 242U * sizeof(real_T));
    SD->f3.t2[51030] = t17;
    memset(&SD->f3.t2[51031], 0, 242U * sizeof(real_T));
    SD->f3.t2[51273] = t17;
    memset(&SD->f3.t2[51274], 0, 242U * sizeof(real_T));
    SD->f3.t2[51516] = t17;
    memset(&SD->f3.t2[51517], 0, 485U * sizeof(real_T));
    SD->f3.t2[52002] = t18;
    memset(&SD->f3.t2[52003], 0, 242U * sizeof(real_T));
    SD->f3.t2[52245] = t18;
    memset(&SD->f3.t2[52246], 0, 242U * sizeof(real_T));
    SD->f3.t2[52488] = t18;
    memset(&SD->f3.t2[52489], 0, 242U * sizeof(real_T));
    SD->f3.t2[52731] = t18;
    memset(&SD->f3.t2[52732], 0, 242U * sizeof(real_T));
    SD->f3.t2[52974] = t19;
    memset(&SD->f3.t2[52975], 0, 242U * sizeof(real_T));
    SD->f3.t2[53217] = t19;
...
/* End of code generation (temp_MPC3DFootV99_form_Step0.cpp) */
