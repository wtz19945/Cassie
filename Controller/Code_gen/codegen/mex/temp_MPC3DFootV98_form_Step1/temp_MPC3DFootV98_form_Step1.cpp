...
static emlrtRSInfo emlrtRSI = { 55,    /* lineNo */
  "temp_MPC3DFootV98_form_Step1",      /* fcnName */
  "D:\\Cassie_Avoidance\\Obstacle_Avoidance_OpenLoopNoCassie\\Code_gen\\temp_MPC3DFootV98_form_Step1.m"/* pathName */
};
...
static emlrtRTEInfo emlrtRTEI = { 1,   /* lineNo */
  34,                                  /* colNo */
  "temp_MPC3DFootV98_form_Step1",      /* fName */
  "D:\\Cassie_Avoidance\\Obstacle_Avoidance_OpenLoopNoCassie\\Code_gen\\temp_MPC3DFootV98_form_Step1.m"/* pName */
};
...
void temp_MPC3DFootV98_form_Step1(c_temp_MPC3DFootV98_form_Step1S *SD, const
  ...
  Aiq[33320], real_T biq[140], real_T H[56644], real_T f[238])
{
  int32_T i;
  real_T x_ref[5];
  real_T y_ref[5];
  ...
  if (MPC_index[0] == 1.0) {
    ...
    /* EQ_LEFTSTART13DFOOTV98 */
    /*     [AEQ,BEQ] = EQ_LEFTSTART13DFOOTV98(IN1,IN2,IN3,ZH1,IN5,IN6,IN7) */
    /*     This function was generated by the Symbolic Math Toolbox version 8.0. */
    /*     06-Jul-2023 15:35:39 */
    t2 = 1.0 / states_ref[6];
    t3 = t2 * 0.981;
    SD->f3.dv2[0] = -1.0;
    ...
    beq[123] = eq_in[1];
    st.site = &c_emlrtRSI;
    Iq_LeftStart13DFootV98(SD, &st, *(real_T (*)[17])&states_ref[7], *(real_T (*)
    ...
    /*  Develop The Objective Function Matrix and Vector */
    Obj_LeftStart13DFootV98(SD, states[4], states[5], x_ref, y_ref, *(real_T (*)
    ...
    /*  Develop the Constraints Matrix and Vector */
    /* EQ_RIGHTSTART13DFOOTV98 */
    /*     [AEQ,BEQ] = EQ_RIGHTSTART13DFOOTV98(IN1,IN2,IN3,ZH1,IN5,IN6,IN7) */
    /*     This function was generated by the Symbolic Math Toolbox version 8.0. */
    /*     06-Jul-2023 15:42:09 */
    t2 = 1.0 / states_ref[6];
    t3 = t2 * 0.981;
    SD->f3.dv2[0] = -1.0;
    SD->f3.dv2[1] = t2 * -0.981;
    ...
    beq[123] = eq_in[1];
    st.site = &d_emlrtRSI;
    Iq_RightStart13DFootV98(SD, &st, *(real_T (*)[17])&states_ref[7], *(real_T (*)
      [17])&states_ref[24], *(real_T (*)[17])&states_ref[41], qo, r1, r2,
      states[4], states[5], *(real_T (*)[3])&foot_info[0], *(real_T (*)[3])&
      foot_info[3], *(real_T (*)[2])&foot_info[6], iq_in, *(real_T (*)[4])&
      foot_future_info[0], *(real_T (*)[4])&foot_future_info[4], *(real_T (*)[8])
    ...
    /*  Develop The Objective Function Matrix and Vector */
    /* OBJ_RIGHTSTART13DFOOTV98 */
    /*     [H,F] = OBJ_RIGHTSTART13DFOOTV98(CPX1,CPY1,IN3,IN4,IN5,IN6,IN7,IN8,CRX1,CRY1,CRZ1,CWX1,CWY1,M1,IN15,IN16) */
    /*     This function was generated by the Symbolic Math Toolbox version 8.0. */
    /*     06-Jul-2023 15:47:34 */
    t2 = weights[1] * 2.0;
    t3 = weights[2] * 2.0;
    t4 = weights[3] * 2.0;
    t5 = weights[4] * 2.0;
    ...
    SD->f3.t2[1434] = t2;
    memset(&SD->f3.t2[1435], 0, 238U * sizeof(real_T));
    SD->f3.t2[1673] = t3;
    memset(&SD->f3.t2[1674], 0, 238U * sizeof(real_T));
    SD->f3.t2[1912] = t2;
    ...
    SD->f3.t2[3346] = t2;
    memset(&SD->f3.t2[3347], 0, 238U * sizeof(real_T));
    SD->f3.t2[3585] = t3;
    memset(&SD->f3.t2[3586], 0, 238U * sizeof(real_T));
    SD->f3.t2[3824] = t2;
    ...
    SD->f3.t2[5258] = t2;
    memset(&SD->f3.t2[5259], 0, 238U * sizeof(real_T));
    SD->f3.t2[5497] = t3;
    memset(&SD->f3.t2[5498], 0, 238U * sizeof(real_T));
    SD->f3.t2[5736] = t2;
    ...
    SD->f3.t2[7170] = t2;
    memset(&SD->f3.t2[7171], 0, 238U * sizeof(real_T));
    SD->f3.t2[7409] = t3;
    memset(&SD->f3.t2[7410], 0, 238U * sizeof(real_T));
    SD->f3.t2[7648] = t2;
    ...
    SD->f3.t2[9560] = t4;
    memset(&SD->f3.t2[9561], 0, 238U * sizeof(real_T));
    SD->f3.t2[9799] = t5;
    memset(&SD->f3.t2[9800], 0, 238U * sizeof(real_T));
    SD->f3.t2[10038] = t4;
    ...
    SD->f3.t2[11472] = t4;
    memset(&SD->f3.t2[11473], 0, 238U * sizeof(real_T));
    SD->f3.t2[11711] = t5;
    memset(&SD->f3.t2[11712], 0, 238U * sizeof(real_T));
    SD->f3.t2[11950] = t4;
    ...
    SD->f3.t2[13384] = t4;
    memset(&SD->f3.t2[13385], 0, 238U * sizeof(real_T));
    SD->f3.t2[13623] = t5;
    memset(&SD->f3.t2[13624], 0, 238U * sizeof(real_T));
    SD->f3.t2[13862] = t4;
    ...
    SD->f3.t2[15296] = t4;
    memset(&SD->f3.t2[15297], 0, 238U * sizeof(real_T));
    SD->f3.t2[15535] = t5;
    memset(&SD->f3.t2[15536], 0, 238U * sizeof(real_T));
    SD->f3.t2[15774] = t4;
    ...
    SD->f3.t2[24139] = t7;
    memset(&SD->f3.t2[24140], 0, 955U * sizeof(real_T));
    SD->f3.t2[25095] = t8;
    ...
    SD->f3.t2[28239] = -t8;
    SD->f3.t2[28240] = -t8;
    memset(&SD->f3.t2[28241], 0, 917U * sizeof(real_T));
    SD->f3.t2[29158] = t9;
    ...
    SD->f3.t2[36328] = t10;
    memset(&SD->f3.t2[36329], 0, 190U * sizeof(real_T));
    SD->f3.t2[36519] = -t8;
    SD->f3.t2[36520] = -t8;
    SD->f3.t2[36521] = -t8;
    SD->f3.t2[36522] = -t8;
    ...
    SD->f3.t2[36567] = weights[5] * 28.0;
    SD->f3.t2[36568] = t11;
    SD->f3.t2[36569] = t12;
    SD->f3.t2[36570] = t13;
    memset(&SD->f3.t2[36571], 0, 190U * sizeof(real_T));
    SD->f3.t2[36761] = -t8;
    SD->f3.t2[36762] = -t8;
    SD->f3.t2[36763] = -t8;
    SD->f3.t2[36764] = -t8;
    ...
    SD->f3.t2[36807] = t12;
    SD->f3.t2[36808] = t13;
    memset(&SD->f3.t2[36809], 0, 194U * sizeof(real_T));
    SD->f3.t2[37003] = -t8;
    SD->f3.t2[37004] = -t8;
    SD->f3.t2[37005] = -t8;
    SD->f3.t2[37006] = -t8;
    ...
    SD->f3.t2[37045] = t12;
    SD->f3.t2[37046] = t13;
    memset(&SD->f3.t2[37047], 0, 198U * sizeof(real_T));
    SD->f3.t2[37245] = -t8;
    SD->f3.t2[37246] = -t8;
    ...
    SD->f3.t2[37283] = t13;
    SD->f3.t2[37284] = t13;
    memset(&SD->f3.t2[37285], 0, 203U * sizeof(real_T));
    SD->f3.t2[37488] = -t9;
    SD->f3.t2[37489] = -t9;
    SD->f3.t2[37490] = -t9;
    SD->f3.t2[37491] = -t9;
    ...
    SD->f3.t2[37523] = weights[6] * 28.0;
    SD->f3.t2[37524] = t14;
    SD->f3.t2[37525] = t15;
    SD->f3.t2[37526] = t16;
    memset(&SD->f3.t2[37527], 0, 203U * sizeof(real_T));
    SD->f3.t2[37730] = -t9;
    SD->f3.t2[37731] = -t9;
    SD->f3.t2[37732] = -t9;
    SD->f3.t2[37733] = -t9;
    ...
    SD->f3.t2[37763] = t15;
    SD->f3.t2[37764] = t16;
    memset(&SD->f3.t2[37765], 0, 207U * sizeof(real_T));
    SD->f3.t2[37972] = -t9;
    SD->f3.t2[37973] = -t9;
    SD->f3.t2[37974] = -t9;
    SD->f3.t2[37975] = -t9;
    ...
    SD->f3.t2[38001] = t15;
    SD->f3.t2[38002] = t16;
    memset(&SD->f3.t2[38003], 0, 211U * sizeof(real_T));
    SD->f3.t2[38214] = -t9;
    SD->f3.t2[38215] = -t9;
...
/* End of code generation (temp_MPC3DFootV98_form_Step1.cpp) */
