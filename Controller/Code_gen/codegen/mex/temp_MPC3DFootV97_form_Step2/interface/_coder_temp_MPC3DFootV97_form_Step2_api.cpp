 ...
 *
 * _coder_temp_MPC3DFootV97_form_Step2_api.cpp
 *
 * Code generation for function '_coder_temp_MPC3DFootV97_form_Step2_api'
 *
 */
...
static const mxArray *c_emlrt_marshallOut(const real_T u[29606]);
...
static const mxArray *c_emlrt_marshallOut(const real_T u[29606])
{
  ...
  static const int32_T iv5[2] = { 131, 226 };
...
void temp_MPC3DFootV97_form_Step2_api(c_temp_MPC3DFootV97_form_Step2S *SD, const
  mxArray * const prhs[9], const mxArray *plhs[6])
{
  ...
  Aiq = (real_T (*)[29606])mxMalloc(sizeof(real_T [29606]));
  ...
  temp_MPC3DFootV97_form_Step2(SD, &st, *states, Nodes, *r, *qo, *states_ref,
...
/* End of code generation (_coder_temp_MPC3DFootV97_form_Step2_api.cpp) */
