 ...
 *
 * Code generation for function '_coder_temp_MPC3DFootV99_form_Step1_api'
 *
 */
...
static const mxArray *c_emlrt_marshallOut(const real_T u[34606]);
...
static const mxArray *c_emlrt_marshallOut(const real_T u[34606])
{
  ...
  static const int32_T iv5[2] = { 143, 242 };
  ...
  const emlrtMsgIdentifier *msgId))[17]
{
  ...
  void temp_MPC3DFootV99_form_Step1_api(c_temp_MPC3DFootV99_form_Step1S *SD,
  const mxArray * const prhs[10], const mxArray *plhs[6])
{
  ...
  Aiq = (real_T (*)[34606])mxMalloc(sizeof(real_T [34606]));
  ...
  temp_MPC3DFootV99_form_Step1(SD, &st, *states, Nodes, *r, *qo, *states_ref,
...
/* End of code generation (_coder_temp_MPC3DFootV99_form_Step1_api.cpp) */
