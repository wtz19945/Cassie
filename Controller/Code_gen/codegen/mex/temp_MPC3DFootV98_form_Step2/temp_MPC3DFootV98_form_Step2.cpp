...
#include "Obj_LeftStart23DFootV98.h"
#include "linspace.h"

/* Variable Definitions */
static emlrtRSInfo emlrtRSI = { 55,    /* lineNo */
  "temp_MPC3DFootV98_form_Step2",      /* fcnName */
  "D:\\Cassie_Avoidance\\Obstacle_Avoidance_OpenLoopNoCassie\\Code_gen\\temp_MPC3DFootV98_form_Step2.m"/* pathName */
};
...
static emlrtRTEInfo emlrtRTEI = { 1,   /* lineNo */
  34,                                  /* colNo */
  "temp_MPC3DFootV98_form_Step2",      /* fName */
  "D:\\Cassie_Avoidance\\Obstacle_Avoidance_OpenLoopNoCassie\\Code_gen\\temp_MPC3DFootV98_form_Step2.m"/* pName */
};
...
void temp_MPC3DFootV98_form_Step2(c_temp_MPC3DFootV98_form_Step2S *SD, const
  ...
  Aiq[31892], real_T biq[134], real_T H[56644], real_T f[238])
{
  int32_T i;
  real_T x_ref[5];
  real_T y_ref[5];
  ...
  if (MPC_index[0] == 1.0) {
    ...
    /* EQ_LEFTSTART23DFOOTV98 */
    /*     [AEQ,BEQ] = EQ_LEFTSTART23DFOOTV98(IN1,IN2,IN3,ZH1,IN5,IN6,IN7) */
    /*     This function was generated by the Symbolic Math Toolbox version 8.0. */
    /*     06-Jul-2023 15:48:34 */
    t2 = 1.0 / states_ref[6];
    t3 = t2 * 0.981;
    SD->f3.dv2[0] = -1.0;
    ...
    beq[123] = eq_in[1];
    st.site = &c_emlrtRSI;
    Iq_LeftStart23DFootV98(SD, &st, *(real_T (*)[17])&states_ref[7], *(real_T (*)
    ...
    /*  Develop The Objective Function Matrix and Vector */
    Obj_LeftStart23DFootV98(SD, states[4], states[5], x_ref, y_ref, *(real_T (*)
    ...
    /*  Develop the Constraints Matrix and Vector */
    /* EQ_RIGHTSTART23DFOOTV98 */
    /*     [AEQ,BEQ] = EQ_RIGHTSTART23DFOOTV98(IN1,IN2,IN3,ZH1,IN5,IN6,IN7) */
    /*     This function was generated by the Symbolic Math Toolbox version 8.0. */
    /*     06-Jul-2023 15:55:05 */
    t2 = 1.0 / states_ref[6];
    t3 = t2 * 0.981;
    SD->f3.dv2[0] = -1.0;
    SD->f3.dv2[1] = t2 * -0.981;
    ...
    beq[123] = eq_in[1];
    st.site = &d_emlrtRSI;
    Iq_RightStart23DFootV98(SD, &st, *(real_T (*)[17])&states_ref[7], *(real_T (*)
      [17])&states_ref[24], *(real_T (*)[17])&states_ref[41], qo, r1, r2,
      states[4], states[5], *(real_T (*)[3])&foot_info[0], *(real_T (*)[3])&
      foot_info[3], *(real_T (*)[2])&foot_info[6], iq_in, *(real_T (*)[4])&
      foot_future_info[0], *(real_T (*)[4])&foot_future_info[4], *(real_T (*)[8])
    ...
    /*  Develop The Objective Function Matrix and Vector */
    /* OBJ_RIGHTSTART23DFOOTV98 */
    /*     [H,F] = OBJ_RIGHTSTART23DFOOTV98(CPX1,CPY1,IN3,IN4,IN5,IN6,IN7,IN8,CRX1,CRY1,CRZ1,CWX1,CWY1,M1,IN15,IN16) */
    /*     This function was generated by the Symbolic Math Toolbox version 8.0. */
    /*     06-Jul-2023 16:00:29 */
    t2 = weights[1] * 2.0;
    t3 = weights[2] * 2.0;
    t4 = weights[3] * 2.0;
    t5 = weights[4] * 2.0;
    ...
    SD->f3.t2[956] = t2;
    memset(&SD->f3.t2[957], 0, 238U * sizeof(real_T));
    SD->f3.t2[1195] = t3;
    memset(&SD->f3.t2[1196], 0, 238U * sizeof(real_T));
    SD->f3.t2[1434] = t2;
    ...
    SD->f3.t2[2868] = t2;
    memset(&SD->f3.t2[2869], 0, 238U * sizeof(real_T));
    SD->f3.t2[3107] = t3;
    memset(&SD->f3.t2[3108], 0, 238U * sizeof(real_T));
    SD->f3.t2[3346] = t2;
    ...
    SD->f3.t2[4780] = t2;
    memset(&SD->f3.t2[4781], 0, 238U * sizeof(real_T));
    SD->f3.t2[5019] = t3;
    memset(&SD->f3.t2[5020], 0, 238U * sizeof(real_T));
    SD->f3.t2[5258] = t2;
    ...
    SD->f3.t2[6692] = t2;
    memset(&SD->f3.t2[6693], 0, 238U * sizeof(real_T));
    SD->f3.t2[6931] = t3;
    memset(&SD->f3.t2[6932], 0, 238U * sizeof(real_T));
    SD->f3.t2[7170] = t2;
    ...
    SD->f3.t2[9082] = t4;
    memset(&SD->f3.t2[9083], 0, 238U * sizeof(real_T));
    SD->f3.t2[9321] = t5;
    memset(&SD->f3.t2[9322], 0, 238U * sizeof(real_T));
    SD->f3.t2[9560] = t4;
    ...
    SD->f3.t2[10994] = t4;
    memset(&SD->f3.t2[10995], 0, 238U * sizeof(real_T));
    SD->f3.t2[11233] = t5;
    memset(&SD->f3.t2[11234], 0, 238U * sizeof(real_T));
    SD->f3.t2[11472] = t4;
    ...
    SD->f3.t2[12906] = t4;
    memset(&SD->f3.t2[12907], 0, 238U * sizeof(real_T));
    SD->f3.t2[13145] = t5;
    memset(&SD->f3.t2[13146], 0, 238U * sizeof(real_T));
    SD->f3.t2[13384] = t4;
    ...
    SD->f3.t2[14818] = t4;
    memset(&SD->f3.t2[14819], 0, 238U * sizeof(real_T));
    SD->f3.t2[15057] = t5;
    memset(&SD->f3.t2[15058], 0, 238U * sizeof(real_T));
    SD->f3.t2[15296] = t4;
    ...
    SD->f3.t2[24139] = t7;
    memset(&SD->f3.t2[24140], 0, 716U * sizeof(real_T));
    SD->f3.t2[24856] = t8;
    ...
    SD->f3.t2[28239] = -t8;
    SD->f3.t2[28240] = -t8;
    memset(&SD->f3.t2[28241], 0, 678U * sizeof(real_T));
    SD->f3.t2[28919] = t9;
    ...
    SD->f3.t2[36328] = t10;
    memset(&SD->f3.t2[36329], 0, 189U * sizeof(real_T));
    SD->f3.t2[36518] = -t8;
    SD->f3.t2[36519] = -t8;
    SD->f3.t2[36520] = -t8;
    SD->f3.t2[36521] = -t8;
    ...
    SD->f3.t2[36567] = weights[5] * 30.0;
    SD->f3.t2[36568] = t11;
    SD->f3.t2[36569] = t12;
    SD->f3.t2[36570] = t13;
    memset(&SD->f3.t2[36571], 0, 189U * sizeof(real_T));
    SD->f3.t2[36760] = -t8;
    SD->f3.t2[36761] = -t8;
    SD->f3.t2[36762] = -t8;
    SD->f3.t2[36763] = -t8;
    ...
    SD->f3.t2[36807] = t12;
    SD->f3.t2[36808] = t13;
    memset(&SD->f3.t2[36809], 0, 193U * sizeof(real_T));
    SD->f3.t2[37002] = -t8;
    SD->f3.t2[37003] = -t8;
    SD->f3.t2[37004] = -t8;
    SD->f3.t2[37005] = -t8;
    ...
    SD->f3.t2[37045] = t12;
    SD->f3.t2[37046] = t13;
    memset(&SD->f3.t2[37047], 0, 197U * sizeof(real_T));
    SD->f3.t2[37244] = -t8;
    SD->f3.t2[37245] = -t8;
    SD->f3.t2[37246] = -t8;
    ...
    SD->f3.t2[37283] = t13;
    SD->f3.t2[37284] = t13;
    memset(&SD->f3.t2[37285], 0, 202U * sizeof(real_T));
    SD->f3.t2[37487] = -t9;
    SD->f3.t2[37488] = -t9;
    SD->f3.t2[37489] = -t9;
    SD->f3.t2[37490] = -t9;
    ...
    SD->f3.t2[37523] = weights[6] * 30.0;
    SD->f3.t2[37524] = t14;
    SD->f3.t2[37525] = t15;
    SD->f3.t2[37526] = t16;
    memset(&SD->f3.t2[37527], 0, 202U * sizeof(real_T));
    SD->f3.t2[37729] = -t9;
    SD->f3.t2[37730] = -t9;
    SD->f3.t2[37731] = -t9;
    SD->f3.t2[37732] = -t9;
    ...
    SD->f3.t2[37763] = t15;
    SD->f3.t2[37764] = t16;
    memset(&SD->f3.t2[37765], 0, 206U * sizeof(real_T));
    SD->f3.t2[37971] = -t9;
    SD->f3.t2[37972] = -t9;
    SD->f3.t2[37973] = -t9;
    SD->f3.t2[37974] = -t9;
    ...
    SD->f3.t2[38001] = t15;
    SD->f3.t2[38002] = t16;
    memset(&SD->f3.t2[38003], 0, 210U * sizeof(real_T));
    SD->f3.t2[38213] = -t9;
    SD->f3.t2[38214] = -t9;
    SD->f3.t2[38215] = -t9;
    ...
    SD->f3.t2[48278] = t9;
    memset(&SD->f3.t2[48279], 0, 955U * sizeof(real_T));
    SD->f3.t2[49234] = t18;
    memset(&SD->f3.t2[49235], 0, 238U * sizeof(real_T));
    SD->f3.t2[49473] = t18;
    memset(&SD->f3.t2[49474], 0, 955U * sizeof(real_T));
    SD->f3.t2[50429] = t19;
    memset(&SD->f3.t2[50430], 0, 238U * sizeof(real_T));
    SD->f3.t2[50668] = t19;
    memset(&SD->f3.t2[50669], 0, 955U * sizeof(real_T));
    SD->f3.t2[51624] = t20;
    memset(&SD->f3.t2[51625], 0, 238U * sizeof(real_T));
    SD->f3.t2[51863] = t20;
    memset(&SD->f3.t2[51864], 0, 716U * sizeof(real_T));
    SD->f3.t2[52580] = t21;
...
/* End of code generation (temp_MPC3DFootV98_form_Step2.cpp) */
