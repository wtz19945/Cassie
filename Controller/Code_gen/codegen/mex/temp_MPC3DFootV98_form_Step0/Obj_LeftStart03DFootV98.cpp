...
void Obj_LeftStart03DFootV98(c_temp_MPC3DFootV98_form_Step0S *SD, real_T Cpx1,
  ...
  in16[26], real_T H[56644], real_T f[238])
{
  ...
  /* OBJ_LEFTSTART03DFOOTV98 */
  /*     [H,F] = OBJ_LEFTSTART03DFOOTV98(CPX1,CPY1,IN3,IN4,IN5,IN6,IN7,IN8,CRX1,CRY1,CRZ1,CWX1,CWY1,M1,IN15,IN16) */
  /*     This function was generated by the Symbolic Math Toolbox version 8.0. */
  /*     06-Jul-2023 15:28:03 */
  t2 = in6[0] * 2.0;
  t3 = in6[1] * 2.0;
  t4 = in7[0] * 2.0;
  t5 = in7[1] * 2.0;
  ...
  SD->u1.f0.t2[1434] = t2;
  memset(&SD->u1.f0.t2[1435], 0, 477U * sizeof(real_T));
  SD->u1.f0.t2[1912] = t2;
  memset(&SD->u1.f0.t2[1913], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[2151] = t3;
  memset(&SD->u1.f0.t2[2152], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[2390] = t2;
  memset(&SD->u1.f0.t2[2391], 0, 477U * sizeof(real_T));
  SD->u1.f0.t2[2868] = t2;
  memset(&SD->u1.f0.t2[2869], 0, 477U * sizeof(real_T));
  SD->u1.f0.t2[3346] = t2;
  memset(&SD->u1.f0.t2[3347], 0, 477U * sizeof(real_T));
  SD->u1.f0.t2[3824] = t2;
  memset(&SD->u1.f0.t2[3825], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[4063] = t3;
  memset(&SD->u1.f0.t2[4064], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[4302] = t2;
  memset(&SD->u1.f0.t2[4303], 0, 477U * sizeof(real_T));
  SD->u1.f0.t2[4780] = t2;
  memset(&SD->u1.f0.t2[4781], 0, 477U * sizeof(real_T));
  SD->u1.f0.t2[5258] = t2;
  memset(&SD->u1.f0.t2[5259], 0, 477U * sizeof(real_T));
  SD->u1.f0.t2[5736] = t2;
  memset(&SD->u1.f0.t2[5737], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[5975] = t3;
  memset(&SD->u1.f0.t2[5976], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[6214] = t2;
  memset(&SD->u1.f0.t2[6215], 0, 477U * sizeof(real_T));
  SD->u1.f0.t2[6692] = t2;
  memset(&SD->u1.f0.t2[6693], 0, 477U * sizeof(real_T));
  SD->u1.f0.t2[7170] = t2;
  memset(&SD->u1.f0.t2[7171], 0, 477U * sizeof(real_T));
  SD->u1.f0.t2[7648] = t2;
  memset(&SD->u1.f0.t2[7649], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[7887] = t3;
  memset(&SD->u1.f0.t2[7888], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[8126] = t4;
  ...
  SD->u1.f0.t2[9560] = t4;
  memset(&SD->u1.f0.t2[9561], 0, 477U * sizeof(real_T));
  SD->u1.f0.t2[10038] = t4;
  memset(&SD->u1.f0.t2[10039], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[10277] = t5;
  memset(&SD->u1.f0.t2[10278], 0, 238U * sizeof(real_T));
  ...
  memset(&SD->u1.f0.t2[11473], 0, 477U * sizeof(real_T));
  SD->u1.f0.t2[11950] = t4;
  memset(&SD->u1.f0.t2[11951], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[12189] = t5;
  memset(&SD->u1.f0.t2[12190], 0, 238U * sizeof(real_T));
  ...
  memset(&SD->u1.f0.t2[13385], 0, 477U * sizeof(real_T));
  SD->u1.f0.t2[13862] = t4;
  memset(&SD->u1.f0.t2[13863], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[14101] = t5;
  memset(&SD->u1.f0.t2[14102], 0, 238U * sizeof(real_T));
  ...
  memset(&SD->u1.f0.t2[15297], 0, 477U * sizeof(real_T));
  SD->u1.f0.t2[15774] = t4;
  memset(&SD->u1.f0.t2[15775], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[16013] = t5;
  memset(&SD->u1.f0.t2[16014], 0, 238U * sizeof(real_T));
  ...
  memset(&SD->u1.f0.t2[24140], 0, 1194U * sizeof(real_T));
  ...
  memset(&SD->u1.f0.t2[26096], 0, 194U * sizeof(real_T));
  ...
  memset(&SD->u1.f0.t2[27049], 0, 197U * sizeof(real_T));
  ...
  memset(&SD->u1.f0.t2[28002], 0, 200U * sizeof(real_T));
  ...
  memset(&SD->u1.f0.t2[28241], 0, 1156U * sizeof(real_T));
  ...
  memset(&SD->u1.f0.t2[30146], 0, 207U * sizeof(real_T));
  ...
  memset(&SD->u1.f0.t2[31099], 0, 210U * sizeof(real_T));
  ...
  memset(&SD->u1.f0.t2[32052], 0, 213U * sizeof(real_T));
  ...
  memset(&SD->u1.f0.t2[36329], 0, 191U * sizeof(real_T));
  ...
  SD->u1.f0.t2[36567] = cRx1 * 26.0;
  SD->u1.f0.t2[36568] = t11;
  SD->u1.f0.t2[36569] = t12;
  SD->u1.f0.t2[36570] = t8;
  memset(&SD->u1.f0.t2[36571], 0, 191U * sizeof(real_T));
  ...
  SD->u1.f0.t2[36808] = t8;
  memset(&SD->u1.f0.t2[36809], 0, 195U * sizeof(real_T));
  ...
  SD->u1.f0.t2[37046] = t8;
  memset(&SD->u1.f0.t2[37047], 0, 199U * sizeof(real_T));
  SD->u1.f0.t2[37246] = -t8;
  memset(&SD->u1.f0.t2[37247], 0, 34U * sizeof(real_T));
  SD->u1.f0.t2[37281] = t8;
  SD->u1.f0.t2[37282] = t8;
  SD->u1.f0.t2[37283] = t8;
  SD->u1.f0.t2[37284] = t8;
  memset(&SD->u1.f0.t2[37285], 0, 204U * sizeof(real_T));
  ...
  SD->u1.f0.t2[37523] = cRy1 * 26.0;
  SD->u1.f0.t2[37524] = t13;
  SD->u1.f0.t2[37525] = t14;
  SD->u1.f0.t2[37526] = t9;
  memset(&SD->u1.f0.t2[37527], 0, 204U * sizeof(real_T));
  ...
  SD->u1.f0.t2[37761] = t13;
  SD->u1.f0.t2[37762] = t13;
  SD->u1.f0.t2[37763] = t14;
  SD->u1.f0.t2[37764] = t9;
  memset(&SD->u1.f0.t2[37765], 0, 208U * sizeof(real_T));
  ...
  memset(&SD->u1.f0.t2[48279], 0, 477U * sizeof(real_T));
  SD->u1.f0.t2[48756] = t16;
  memset(&SD->u1.f0.t2[48757], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[48995] = t16;
  memset(&SD->u1.f0.t2[48996], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[49234] = t16;
  memset(&SD->u1.f0.t2[49235], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[49473] = t16;
  memset(&SD->u1.f0.t2[49474], 0, 477U * sizeof(real_T));
  SD->u1.f0.t2[49951] = t17;
  memset(&SD->u1.f0.t2[49952], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[50190] = t17;
  memset(&SD->u1.f0.t2[50191], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[50429] = t17;
  memset(&SD->u1.f0.t2[50430], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[50668] = t17;
  memset(&SD->u1.f0.t2[50669], 0, 477U * sizeof(real_T));
  SD->u1.f0.t2[51146] = t18;
  memset(&SD->u1.f0.t2[51147], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[51385] = t18;
  memset(&SD->u1.f0.t2[51386], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[51624] = t18;
  memset(&SD->u1.f0.t2[51625], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[51863] = t18;
  memset(&SD->u1.f0.t2[51864], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[52102] = t19;
  memset(&SD->u1.f0.t2[52103], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[52341] = t19;
  memset(&SD->u1.f0.t2[52342], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[52580] = t19;
  memset(&SD->u1.f0.t2[52581], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[52819] = t19;
  memset(&SD->u1.f0.t2[52820], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[53058] = t20;
  memset(&SD->u1.f0.t2[53059], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[53297] = t20;
  memset(&SD->u1.f0.t2[53298], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[53536] = t20;
  memset(&SD->u1.f0.t2[53537], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[53775] = t20;
  memset(&SD->u1.f0.t2[53776], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[54014] = t21;
  memset(&SD->u1.f0.t2[54015], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[54253] = t21;
  memset(&SD->u1.f0.t2[54254], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[54492] = t21;
  memset(&SD->u1.f0.t2[54493], 0, 238U * sizeof(real_T));
  SD->u1.f0.t2[54731] = t21;
...
/* End of code generation (Obj_LeftStart03DFootV98.cpp) */
