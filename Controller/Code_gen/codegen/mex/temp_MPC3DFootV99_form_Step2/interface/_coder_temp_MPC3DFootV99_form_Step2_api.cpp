 ...
 *
 * Code generation for function '_coder_temp_MPC3DFootV99_form_Step2_api'
 *
 */
...
static const mxArray *c_emlrt_marshallOut(const real_T u[33154]);
...
static const mxArray *c_emlrt_marshallOut(const real_T u[33154])
{
  ...
  static const int32_T iv5[2] = { 137, 242 };
  ...
  const emlrtMsgIdentifier *msgId))[17]
{
  ...
  void temp_MPC3DFootV99_form_Step2_api(c_temp_MPC3DFootV99_form_Step2S *SD,
  const mxArray * const prhs[10], const mxArray *plhs[6])
{
  ...
  Aiq = (real_T (*)[33154])mxMalloc(sizeof(real_T [33154]));
  ...
  temp_MPC3DFootV99_form_Step2(SD, &st, *states, Nodes, *r, *qo, *states_ref,
...
/* End of code generation (_coder_temp_MPC3DFootV99_form_Step2_api.cpp) */
