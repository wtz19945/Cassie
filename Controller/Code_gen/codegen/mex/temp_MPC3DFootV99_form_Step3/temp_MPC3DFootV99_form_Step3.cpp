...
static emlrtRSInfo emlrtRSI = { 55,    /* lineNo */
  "temp_MPC3DFootV99_form_Step3",      /* fcnName */
  "D:\\Cassie_Avoidance\\Obstacle_Avoidance_OpenLoopNoCassie\\Code_gen\\temp_MPC3DFootV99_form_Step3.m"/* pathName */
};
...
static emlrtRTEInfo emlrtRTEI = { 1,   /* lineNo */
  34,                                  /* colNo */
  "temp_MPC3DFootV99_form_Step3",      /* fName */
  "D:\\Cassie_Avoidance\\Obstacle_Avoidance_OpenLoopNoCassie\\Code_gen\\temp_MPC3DFootV99_form_Step3.m"/* pName */
};
...
void temp_MPC3DFootV99_form_Step3(c_temp_MPC3DFootV99_form_Step3S *SD, const
  ...
  Aiq[31702], real_T biq[131], real_T H[58564], real_T f[242])
{
  int32_T i;
  real_T x_ref[5];
  real_T y_ref[5];
  ...
  if (MPC_index[0] == 1.0) {
    ...
    Eq_LeftStart33DFootV99(SD, *(real_T (*)[2])&states[0], *(real_T (*)[2])&
      states[2], *(real_T (*)[2])&states[6], states_ref[6], *(real_T (*)[3])&
      foot_info[0], *(real_T (*)[3])&foot_info[3], eq_in, Aeq, beq);
    st.site = &c_emlrtRSI;
    Iq_LeftStart33DFootV99(SD, &st, *(real_T (*)[17])&states_ref[7], *(real_T (*)
    ...
    /*  Develop The Objective Function Matrix and Vector */
    /* OBJ_LEFTSTART33DFOOTV99 */
    /*     [H,F] = OBJ_LEFTSTART33DFOOTV99(CPX1,CPY1,IN3,IN4,IN5,IN6,IN7,IN8,CRX1,CRY1,CRZ1,CWX1,CWY1,M1,IN15,IN16) */
    /*     This function was generated by the Symbolic Math Toolbox version 8.0. */
    /*     10-Jul-2023 17:41:17 */
    t2 = weights[1] * 2.0;
    t3 = weights[2] * 2.0;
    t4 = weights[3] * 2.0;
    t5 = weights[4] * 2.0;
    ...
    SD->f3.t2[486] = t2;
    memset(&SD->f3.t2[487], 0, 242U * sizeof(real_T));
    SD->f3.t2[729] = t3;
    memset(&SD->f3.t2[730], 0, 242U * sizeof(real_T));
    SD->f3.t2[972] = t2;
    memset(&SD->f3.t2[973], 0, 485U * sizeof(real_T));
    SD->f3.t2[1458] = t2;
    memset(&SD->f3.t2[1459], 0, 485U * sizeof(real_T));
    SD->f3.t2[1944] = t2;
    memset(&SD->f3.t2[1945], 0, 485U * sizeof(real_T));
    SD->f3.t2[2430] = t2;
    memset(&SD->f3.t2[2431], 0, 242U * sizeof(real_T));
    SD->f3.t2[2673] = t3;
    memset(&SD->f3.t2[2674], 0, 242U * sizeof(real_T));
    SD->f3.t2[2916] = t2;
    memset(&SD->f3.t2[2917], 0, 485U * sizeof(real_T));
    SD->f3.t2[3402] = t2;
    memset(&SD->f3.t2[3403], 0, 485U * sizeof(real_T));
    SD->f3.t2[3888] = t2;
    memset(&SD->f3.t2[3889], 0, 485U * sizeof(real_T));
    SD->f3.t2[4374] = t2;
    memset(&SD->f3.t2[4375], 0, 242U * sizeof(real_T));
    SD->f3.t2[4617] = t3;
    memset(&SD->f3.t2[4618], 0, 242U * sizeof(real_T));
    SD->f3.t2[4860] = t2;
    memset(&SD->f3.t2[4861], 0, 485U * sizeof(real_T));
    SD->f3.t2[5346] = t2;
    memset(&SD->f3.t2[5347], 0, 485U * sizeof(real_T));
    SD->f3.t2[5832] = t2;
    memset(&SD->f3.t2[5833], 0, 485U * sizeof(real_T));
    SD->f3.t2[6318] = t2;
    memset(&SD->f3.t2[6319], 0, 242U * sizeof(real_T));
    SD->f3.t2[6561] = t3;
    memset(&SD->f3.t2[6562], 0, 242U * sizeof(real_T));
    SD->f3.t2[6804] = t2;
    memset(&SD->f3.t2[6805], 0, 485U * sizeof(real_T));
    SD->f3.t2[7290] = t2;
    memset(&SD->f3.t2[7291], 0, 485U * sizeof(real_T));
    SD->f3.t2[7776] = t2;
    memset(&SD->f3.t2[7777], 0, 485U * sizeof(real_T));
    SD->f3.t2[8262] = t4;
    memset(&SD->f3.t2[8263], 0, 485U * sizeof(real_T));
    SD->f3.t2[8748] = t4;
    memset(&SD->f3.t2[8749], 0, 242U * sizeof(real_T));
    SD->f3.t2[8991] = t5;
    memset(&SD->f3.t2[8992], 0, 242U * sizeof(real_T));
    SD->f3.t2[9234] = t4;
    memset(&SD->f3.t2[9235], 0, 485U * sizeof(real_T));
    SD->f3.t2[9720] = t4;
    memset(&SD->f3.t2[9721], 0, 485U * sizeof(real_T));
    SD->f3.t2[10206] = t4;
    memset(&SD->f3.t2[10207], 0, 485U * sizeof(real_T));
    SD->f3.t2[10692] = t4;
    memset(&SD->f3.t2[10693], 0, 242U * sizeof(real_T));
    SD->f3.t2[10935] = t5;
    memset(&SD->f3.t2[10936], 0, 242U * sizeof(real_T));
    SD->f3.t2[11178] = t4;
    memset(&SD->f3.t2[11179], 0, 485U * sizeof(real_T));
    SD->f3.t2[11664] = t4;
    memset(&SD->f3.t2[11665], 0, 485U * sizeof(real_T));
    SD->f3.t2[12150] = t4;
    memset(&SD->f3.t2[12151], 0, 485U * sizeof(real_T));
    SD->f3.t2[12636] = t4;
    memset(&SD->f3.t2[12637], 0, 242U * sizeof(real_T));
    SD->f3.t2[12879] = t5;
    memset(&SD->f3.t2[12880], 0, 242U * sizeof(real_T));
    SD->f3.t2[13122] = t4;
    memset(&SD->f3.t2[13123], 0, 485U * sizeof(real_T));
    SD->f3.t2[13608] = t4;
    memset(&SD->f3.t2[13609], 0, 485U * sizeof(real_T));
    SD->f3.t2[14094] = t4;
    memset(&SD->f3.t2[14095], 0, 485U * sizeof(real_T));
    SD->f3.t2[14580] = t4;
    memset(&SD->f3.t2[14581], 0, 242U * sizeof(real_T));
    SD->f3.t2[14823] = t5;
    memset(&SD->f3.t2[14824], 0, 242U * sizeof(real_T));
    SD->f3.t2[15066] = t4;
    memset(&SD->f3.t2[15067], 0, 485U * sizeof(real_T));
    SD->f3.t2[15552] = t4;
    memset(&SD->f3.t2[15553], 0, 485U * sizeof(real_T));
    SD->f3.t2[16038] = t4;
    ...
    SD->f3.t2[24543] = t7;
    memset(&SD->f3.t2[24544], 0, 485U * sizeof(real_T));
    SD->f3.t2[25029] = t8;
    memset(&SD->f3.t2[25030], 0, 49U * sizeof(real_T));
    SD->f3.t2[25079] = -t8;
    memset(&SD->f3.t2[25080], 0, 192U * sizeof(real_T));
    SD->f3.t2[25272] = t8;
    memset(&SD->f3.t2[25273], 0, 48U * sizeof(real_T));
    SD->f3.t2[25321] = -t8;
    memset(&SD->f3.t2[25322], 0, 193U * sizeof(real_T));
    SD->f3.t2[25515] = t8;
    ...
    SD->f3.t2[26047] = -t8;
    SD->f3.t2[26048] = -t8;
    memset(&SD->f3.t2[26049], 0, 195U * sizeof(real_T));
    SD->f3.t2[26244] = t8;
    memset(&SD->f3.t2[26245], 0, 44U * sizeof(real_T));
    SD->f3.t2[26289] = -t8;
    SD->f3.t2[26290] = -t8;
    memset(&SD->f3.t2[26291], 0, 196U * sizeof(real_T));
    SD->f3.t2[26487] = t8;
    ...
    SD->f3.t2[27016] = -t8;
    SD->f3.t2[27017] = -t8;
    memset(&SD->f3.t2[27018], 0, 198U * sizeof(real_T));
    SD->f3.t2[27216] = t8;
    memset(&SD->f3.t2[27217], 0, 40U * sizeof(real_T));
    SD->f3.t2[27257] = -t8;
    SD->f3.t2[27258] = -t8;
    SD->f3.t2[27259] = -t8;
    memset(&SD->f3.t2[27260], 0, 199U * sizeof(real_T));
    SD->f3.t2[27459] = t8;
    ...
    SD->f3.t2[27985] = -t8;
    SD->f3.t2[27986] = -t8;
    memset(&SD->f3.t2[27987], 0, 201U * sizeof(real_T));
    SD->f3.t2[28188] = t8;
    ...
    SD->f3.t2[28227] = -t8;
    SD->f3.t2[28228] = -t8;
    memset(&SD->f3.t2[28229], 0, 202U * sizeof(real_T));
    SD->f3.t2[28431] = t8;
    ...
    SD->f3.t2[28711] = -t8;
    SD->f3.t2[28712] = -t8;
    memset(&SD->f3.t2[28713], 0, 447U * sizeof(real_T));
    SD->f3.t2[29160] = t9;
    memset(&SD->f3.t2[29161], 0, 36U * sizeof(real_T));
    SD->f3.t2[29197] = -t9;
    memset(&SD->f3.t2[29198], 0, 205U * sizeof(real_T));
    SD->f3.t2[29403] = t9;
    memset(&SD->f3.t2[29404], 0, 35U * sizeof(real_T));
    SD->f3.t2[29439] = -t9;
    memset(&SD->f3.t2[29440], 0, 206U * sizeof(real_T));
    SD->f3.t2[29646] = t9;
    ...
    SD->f3.t2[30165] = -t9;
    SD->f3.t2[30166] = -t9;
    memset(&SD->f3.t2[30167], 0, 208U * sizeof(real_T));
    SD->f3.t2[30375] = t9;
    memset(&SD->f3.t2[30376], 0, 31U * sizeof(real_T));
    SD->f3.t2[30407] = -t9;
    SD->f3.t2[30408] = -t9;
    memset(&SD->f3.t2[30409], 0, 209U * sizeof(real_T));
    SD->f3.t2[30618] = t9;
    ...
    SD->f3.t2[31134] = -t9;
    SD->f3.t2[31135] = -t9;
    memset(&SD->f3.t2[31136], 0, 211U * sizeof(real_T));
    SD->f3.t2[31347] = t9;
    memset(&SD->f3.t2[31348], 0, 27U * sizeof(real_T));
    SD->f3.t2[31375] = -t9;
    SD->f3.t2[31376] = -t9;
    SD->f3.t2[31377] = -t9;
    memset(&SD->f3.t2[31378], 0, 212U * sizeof(real_T));
    SD->f3.t2[31590] = t9;
    ...
    SD->f3.t2[32103] = -t9;
    SD->f3.t2[32104] = -t9;
    memset(&SD->f3.t2[32105], 0, 214U * sizeof(real_T));
    SD->f3.t2[32319] = t9;
    ...
    SD->f3.t2[32345] = -t9;
    SD->f3.t2[32346] = -t9;
    memset(&SD->f3.t2[32347], 0, 215U * sizeof(real_T));
    SD->f3.t2[32562] = t9;
    ...
    SD->f3.t2[36936] = t10;
    memset(&SD->f3.t2[36937], 0, 192U * sizeof(real_T));
    SD->f3.t2[37129] = -t8;
    SD->f3.t2[37130] = -t8;
    SD->f3.t2[37131] = -t8;
    SD->f3.t2[37132] = -t8;
    ...
    SD->f3.t2[37179] = weights[5] * 32.0;
    SD->f3.t2[37180] = t11;
    SD->f3.t2[37181] = t12;
    SD->f3.t2[37182] = t13;
    memset(&SD->f3.t2[37183], 0, 192U * sizeof(real_T));
    SD->f3.t2[37375] = -t8;
    SD->f3.t2[37376] = -t8;
    SD->f3.t2[37377] = -t8;
    SD->f3.t2[37378] = -t8;
    ...
    SD->f3.t2[37423] = t12;
    SD->f3.t2[37424] = t13;
    memset(&SD->f3.t2[37425], 0, 196U * sizeof(real_T));
    SD->f3.t2[37621] = -t8;
    SD->f3.t2[37622] = -t8;
    SD->f3.t2[37623] = -t8;
    SD->f3.t2[37624] = -t8;
    ...
    SD->f3.t2[37665] = t12;
    SD->f3.t2[37666] = t13;
    memset(&SD->f3.t2[37667], 0, 200U * sizeof(real_T));
    SD->f3.t2[37867] = -t8;
    SD->f3.t2[37868] = -t8;
    SD->f3.t2[37869] = -t8;
    SD->f3.t2[37870] = -t8;
    ...
    SD->f3.t2[37907] = t13;
    SD->f3.t2[37908] = t13;
    memset(&SD->f3.t2[37909], 0, 205U * sizeof(real_T));
    SD->f3.t2[38114] = -t9;
    SD->f3.t2[38115] = -t9;
    SD->f3.t2[38116] = -t9;
    SD->f3.t2[38117] = -t9;
    ...
    SD->f3.t2[38151] = weights[6] * 32.0;
    SD->f3.t2[38152] = t14;
    SD->f3.t2[38153] = t15;
    SD->f3.t2[38154] = t16;
    memset(&SD->f3.t2[38155], 0, 205U * sizeof(real_T));
    SD->f3.t2[38360] = -t9;
    SD->f3.t2[38361] = -t9;
    SD->f3.t2[38362] = -t9;
    SD->f3.t2[38363] = -t9;
    ...
    SD->f3.t2[38395] = t15;
    SD->f3.t2[38396] = t16;
    memset(&SD->f3.t2[38397], 0, 209U * sizeof(real_T));
    SD->f3.t2[38606] = -t9;
    SD->f3.t2[38607] = -t9;
    SD->f3.t2[38608] = -t9;
    SD->f3.t2[38609] = -t9;
    ...
    SD->f3.t2[38637] = t15;
    SD->f3.t2[38638] = t16;
    memset(&SD->f3.t2[38639], 0, 213U * sizeof(real_T));
    SD->f3.t2[38852] = -t9;
    SD->f3.t2[38853] = -t9;
    SD->f3.t2[38854] = -t9;
    SD->f3.t2[38855] = -t9;
    ...
    SD->f3.t2[49086] = t9;
    memset(&SD->f3.t2[49087], 0, 1214U * sizeof(real_T));
    SD->f3.t2[50301] = obj_in[1] * 2.0;
    memset(&SD->f3.t2[50302], 0, 1214U * sizeof(real_T));
    SD->f3.t2[51516] = obj_in[2] * 2.0;
    memset(&SD->f3.t2[51517], 0, 1214U * sizeof(real_T));
    SD->f3.t2[52731] = obj_in[3] * 2.0;
    memset(&SD->f3.t2[52732], 0, 971U * sizeof(real_T));
    SD->f3.t2[53703] = obj_in[0] * 2.0;
    ...
    /*  Develop the Constraints Matrix and Vector */
    /* EQ_RIGHTSTART33DFOOTV99 */
    /*     [AEQ,BEQ] = EQ_RIGHTSTART33DFOOTV99(IN1,IN2,IN3,ZH1,IN5,IN6,IN7) */
    /*     This function was generated by the Symbolic Math Toolbox version 8.0. */
    /*     10-Jul-2023 17:42:22 */
    t2 = 1.0 / states_ref[6];
    t3 = t2 * 0.981;
    SD->f3.dv2[0] = -1.0;
    ...
    beq[123] = eq_in[1];
    st.site = &d_emlrtRSI;
    Iq_RightStart33DFootV99(SD, &st, *(real_T (*)[17])&states_ref[7], *(real_T (*)
      [17])&states_ref[24], *(real_T (*)[17])&states_ref[41], qo, r1, r2,
      states[4], states[5], *(real_T (*)[3])&foot_info[0], *(real_T (*)[3])&
      foot_info[3], *(real_T (*)[2])&foot_info[6], iq_in, *(real_T (*)[4])&
      foot_future_info[0], *(real_T (*)[4])&foot_future_info[4], *(real_T (*)[8])
    ...
    /*  Develop The Objective Function Matrix and Vector */
    /* OBJ_RIGHTSTART33DFOOTV99 */
    /*     [H,F] = OBJ_RIGHTSTART33DFOOTV99(CPX1,CPY1,IN3,IN4,IN5,IN6,IN7,IN8,CRX1,CRY1,CRZ1,CWX1,CWY1,M1,IN15,IN16) */
    /*     This function was generated by the Symbolic Math Toolbox version 8.0. */
    /*     10-Jul-2023 17:48:11 */
    t2 = weights[1] * 2.0;
    t3 = weights[2] * 2.0;
    t4 = weights[3] * 2.0;
    t5 = weights[4] * 2.0;
...
/* End of code generation (temp_MPC3DFootV99_form_Step3.cpp) */
