 ...
 *
 * _coder_temp_MPC3DFootV99_form_Step3_api.cpp
 *
 * Code generation for function '_coder_temp_MPC3DFootV99_form_Step3_api'
 *
 */
...
static const mxArray *c_emlrt_marshallOut(const real_T u[31702]);
...
static const mxArray *c_emlrt_marshallOut(const real_T u[31702])
{
  ...
  static const int32_T iv5[2] = { 131, 242 };
  ...
  const emlrtMsgIdentifier *msgId))[17]
{
  ...
  void temp_MPC3DFootV99_form_Step3_api(c_temp_MPC3DFootV99_form_Step3S *SD,
  const mxArray * const prhs[10], const mxArray *plhs[6])
{
  ...
  Aiq = (real_T (*)[31702])mxMalloc(sizeof(real_T [31702]));
  ...
  temp_MPC3DFootV99_form_Step3(SD, &st, *states, Nodes, *r, *qo, *states_ref,
...
/* End of code generation (_coder_temp_MPC3DFootV99_form_Step3_api.cpp) */
