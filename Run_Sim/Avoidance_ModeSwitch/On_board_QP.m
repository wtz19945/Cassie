    ...
    methods (Access = protected)
        ...
        function [userInputs,result,foot_info] = stepImpl(obj, cassieOutputs, Inertia, Jaco,contact_comd,acc_comd,other_info, weights)
            ...
            if cassieOutputs.isCalibrated
                ...
                [result,flag] = OSC_qp_controller_walking(M,G,B,Jfl,Jfr,Js,A,Adot,pelv_acc,dq,Jfldot,Jfrdot,obj.sol_prev,acc_feet,contact,contact_lam,weights,torque_bound,qdd_range,traj_time);
