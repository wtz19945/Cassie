function [q, status] = testLegIK_Standing(leftFootTransform, rightFootTransform)
  ...
  if nargin == 0
    ...
    leftFootTransform = Transform3d(Vector3d(0, 0.115, -1));
    rightFootTransform = Transform3d(Vector3d(0, -0.115, -1));
  end % if
