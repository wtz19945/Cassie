...
#include "_coder_kin_right_arm_mex.h"
...
void kin_right_arm_api(const mxArray * const prhs[1], const mxArray *plhs[2])
{
  real_T (*p_right_hand)[3];
  real_T (*Jp_right_hand)[30];
  real_T (*q)[10];
  ...
  p_right_hand = (real_T (*)[3])mxMalloc(sizeof(real_T [3]));
  Jp_right_hand = (real_T (*)[30])mxMalloc(sizeof(real_T [30]));

  /* Marshall function inputs */
  q = emlrt_marshallIn(&st, emlrtAlias((const mxArray *)prhs[0]), "q");

  /* Invoke the target function */
  kin_right_arm(*q, *p_right_hand, *Jp_right_hand);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*p_right_hand);
  plhs[1] = b_emlrt_marshallOut(*Jp_right_hand);
}

void kin_right_arm_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  kin_right_arm_xil_terminate();
}

void kin_right_arm_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void kin_right_arm_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_kin_right_arm_api.c) */
