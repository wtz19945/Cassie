function s = FixedCassieDescriptor
  ...
  s(end).Ic = 0*[3.754 4487 4488 -0.0374 -0.0161 0] / 1000000;
  s(end).Sw = [0 0 0];
  s(end).Sv = [0 0 0];
  ...
  s(end).Ic = 0*[2.779 1774 1775 -0.0234 -0.0081 0] / 1000000;
  s(end).Sw = [0 0 0];
  s(end).Sv = [0 0 0];
